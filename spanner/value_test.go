...
func TestEncodeValue(t *testing.T) {
	...
	for i, test := range []struct {
		...
		{singer1ProtoEnum, protoEnumProto(singer1ProtoEnum), tProtoEnum, "Proto Enum Type 1"},
		{&singer1ProtoEnum, protoEnumProto(singer1ProtoEnum), tProtoEnum, "Proto Enum Type 2"},
